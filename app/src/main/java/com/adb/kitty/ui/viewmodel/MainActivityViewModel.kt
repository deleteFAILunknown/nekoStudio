...
class MainActivityViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _adbCommands = listOf(
        ...
        AdbCommand("打开放大功能", "su -c am start -n com.android.settings/.Settings\\\$MagnificationActivity"),
